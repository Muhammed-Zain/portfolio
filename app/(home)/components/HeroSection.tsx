...
const HeroSection = () => {
     return (
          <div className='min-h-[60vh] gap-14 flex flex-col-reverse items-center justify-between lg:flex-row lg:gap-0 animate-move-up' >
               <div className='space-y-10 text-center lg:text-left'>
                    <h1 className='text-4xl lg:text-7xl font-bold'>
                         Nice to meet you! 👋<br /> <span className='underline underline-offset-8 decoration-green-500'>{"I'm Muhammed Zain."}</span>
                    </h1>
