          ...
          <div className='min-h-[50vh] md:min-h-[60vh] gap-14 flex flex-col-reverse items-center justify-between lg:flex-row lg:gap-0 animate-move-up' >
               <div className='space-y-10 text-center lg:text-left'>
                    ...
                    <div className='flex gap-5 flex-col md:flex-row justify-center lg:justify-start items-center md:items-start'>
                         <Link href={"mailto:muhammedzainjambagi@gmail.com"} target="_blank" className='inline-block group mb-12 md:mb-0'>
                         ...
                         >
                              <Link href={"https://drive.google.com/file/d/1AurjdropElA26EG1ImTI0noc5WAT8lhp/view?usp=sharing"} target="_blank">
                                   <h1 className='text-xl flex justify-center items-center gap-5 '>
                                        <svg width="10%" height="10%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             ...
                                             <g id="SVGRepo_iconCarrier"> <path d="M3 15C3 17.8284 3 19.2426 3.87868 20.1213C4.75736 21 6.17157 21 9 21H15C17.8284 21 19.2426 21 20.1213 20.1213C21 19.2426 21 17.8284 21 15" stroke="#f3ffbd" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> <path d="M12 3V16M12 16L16 11.625M12 16L8 11.625" stroke="#f3ffbd" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> </g>

                                        </svg> <div className='text-sm md:text-xl'>Download Resume</div></h1>
                              </Link>
                         </MovingBorderBtn>
                    </div>
